const WhyCard = ({ img, title, desc }) => {
  return (
    <div className="flex max-w-[380px] justify-center items-center flex-col text-center gap-5 pt-[60px] pb-[50px] px-5 xl:px-[40px] w-full border border-solid border-[#FFFFFF21] bg-[#FFFFFF0F] rounded-[30px]">
